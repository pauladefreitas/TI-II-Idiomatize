...
function initPage() {
    ...
    document.getElementById('nomeUsuario').innerHTML = `<a class="nav-link links-usuario--profile" href="http://localhost:6789/usuario/perfil/${usuarioCorrente.id}"><img src="http://localhost:6789/imgs/${usuarioCorrente.imagem}" alt="Foto de perfil">${usuarioCorrente.nome}</a>`;
}